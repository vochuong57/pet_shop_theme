...
<div class="woocommerce-form-coupon-toggle">
	<?php wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', esc_html__( 'Bạn có mã giảm giá?', 'woocommerce' ) . ' <a href="#" class="showcoupon">' . esc_html__( 'Click vào đây để nhập mã giảm giá của bạn', 'woocommerce' ) . '</a>' ), 'notice' ); ?>
</div>
